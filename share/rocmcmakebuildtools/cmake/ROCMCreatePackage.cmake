...
macro(rocm_create_package)
    ...
    set(oneValueArgs NAME DESCRIPTION SECTION MAINTAINER LINTIAN_OVERRIDES DEBIAN_PKGING LDCONFIG_DIR PREFIX SUFFIX)
	...
	message(STATUS "POTATO CPACK_DEBIAN_PACKAGE_MAINTAINER: ${CPACK_DEBIAN_PACKAGE_MAINTAINER}")
	string(REGEX MATCH "^(.*)\<" _ "${CPACK_DEBIAN_PACKAGE_MAINTAINER}")
    	set(MAINTAINER_NM "${CMAKE_MATCH_1}")
    	# parse text between '<...>'
    	string(REGEX MATCH "<([^>]+)>" _ "${CPACK_DEBIAN_PACKAGE_MAINTAINER}")
    	set(MAINTAINER_EMAIL "${CMAKE_MATCH_1}")
    	message(STATUS "POTATO MAINTAINER_NM: ${MAINTAINER_NM}, MAINTAINER_EMAIL: ${MAINTAINER_EMAIL}")
	endif()
