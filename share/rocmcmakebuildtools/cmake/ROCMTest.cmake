...
function(rocm_save_test)
    ...
    get_property(PROPS GLOBAL PROPERTY _rocm_test_props_${PARSE_NAME})
    if(PROPS)
...
function(rocm_save_test_props NAME)
    ...
    endforeach()
    set_property(GLOBAL PROPERTY _rocm_test_props_${NAME} "${PROPS}")
endfunction()
