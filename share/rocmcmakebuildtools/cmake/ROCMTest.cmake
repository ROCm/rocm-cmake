...
set(_rocm_test_props_file ${_rocm_test_package_dir}/test-props.cmake)
file(MAKE_DIRECTORY ${_rocm_test_package_dir})
file(WRITE ${_rocm_test_run_save_tests} "")
file(WRITE ${_rocm_test_props_file} "")
...
function(rocm_save_test_props NAME)
    set(PROP_NAMES
        ATTACHED_FILES
    ...
    foreach(PROPERTY ${PROP_NAMES})
        get_test_property(${NAME} ${PROPERTY} VALUE)
        if(VALUE)
            string(APPEND PROPS " ${PROPERTY} \"${VALUE}\"")
        endif()
    endforeach()
    if(PROPS)
        file(APPEND ${_rocm_test_props_file} "set_tests_properties(${NAME} PROPERTIES ${PROPS})\n")
    endif()
endfunction()
...
function(rocm_add_test)
    ...
    cmake_language(EVAL CODE "cmake_language(DEFER CALL rocm_save_test_props \"${PARSE_NAME}\")")
...
function(rocm_test_install_ctest)
    ...
    file(READ ${_rocm_test_props_file} _rocm_test_props_content)
    file(APPEND ${_rocm_test_config_file}.in "${_rocm_test_props_content}")
