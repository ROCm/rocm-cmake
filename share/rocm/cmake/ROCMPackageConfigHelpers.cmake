...
macro(find_pkg_config_dependency dep)
    if (NOT \${dep}_FOUND)
        find_dependency(PkgConfig)
        pkg_check_modules(\${dep} QUIET IMPORTED_TARGET \${ARGN})
        if (NOT \${dep}_FOUND)
            set(\${CMAKE_FIND_PACKAGE_NAME}_NOT_FOUND_MESSAGE \"\${CMAKE_FIND_PACKAGE_NAME} could not be found because dependency pkg_check_modules(\${dep} \${ARGN}) could not be found.\")
            set(\${CMAKE_FIND_PACKAGE_NAME}_FOUND False)
            return()
        endif()
    endif()
