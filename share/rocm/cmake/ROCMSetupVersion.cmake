...
function(rocm_setup_version)
    ...
    set(oneValueArgs VERSION PARENT SOVERSION)
    set(multiValueArgs)
    ...
    if(PARSE_SOVERSION)
        rocm_set_parent(PROJECT_SOVERSION ${PARSE_SOVERSION})
        rocm_set_parent(${PROJECT_NAME}_SOVERSION ${PARSE_SOVERSION})
        rocm_version_regex_parse("^([0-9]+).*" _version_MAJOR "${PROJECT_SOVERSION}")
        rocm_version_regex_parse("^[0-9]+\\.([0-9]+).*" _version_MINOR "${PROJECT_SOVERSION}")
        foreach(level MAJOR MINOR)
            rocm_set_parent(${PROJECT_NAME}_SOVERSION_${level} ${_version_${level}})
