...
function(rocm_install_targets)
    ...
    install(TARGETS ${PARSE_TARGETS} 
        EXPORT ${EXPORT_FILE}
        RUNTIME DESTINATION ${BIN_INSTALL_DIR} COMPONENT ${RUNTIME_COMPONENT}
        LIBRARY DESTINATION ${LIB_INSTALL_DIR} COMPONENT ${RUNTIME_COMPONENT}
        ARCHIVE DESTINATION ${LIB_INSTALL_DIR} COMPONENT ${RUNTIME_COMPONENT}
    )
