...
macro(rocm_enable_clang_tidy)
    ...
    if(${CLANG_TIDY_VERSION} VERSION_GREATER "11.0.0" AND CLANG_TIDY_USE_COLOR AND NOT ROCM_ENABLE_GH_ANNOTATIONS)
    ...
    set(CLANG_TIDY_COMMAND
        ${CLANG_TIDY_EXE} ${CLANG_TIDY_USE_COLOR_ARGS} ${CLANG_TIDY_CONFIG_ARG} ${CLANG_TIDY_QUIET_ARG} ${CLANG_TIDY_ENABLE_ALPHA_CHECKS_ARGS} -p
