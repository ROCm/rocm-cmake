...
function(rocm_wrap_header_file)
    ...
    foreach(INCLUDE_FILE IN LISTS PARSE_HEADERS)
        ...
        while(first_time OR GUARD_LIST OR WRAPPER_LOC_LIST OR OUTPUT_LOC_LIST)
            ...
            message(STATUS "Item information:")
            message(STATUS "\tGuard: ${ITEM_GUARD}")
            message(STATUS "\tWrapper location: ${ITEM_WRAPPER_LOCATION}")
            message(STATUS "\tOutput location: ${ITEM_OUTPUT_LOCATION}")
