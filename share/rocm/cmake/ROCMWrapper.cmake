...
function(rocm_wrap_header_dir)
    cmake_parse_arguments(PARSE "" "DIRECTORY;GUARD;LOCATION" "PATTERNS" ${argv})
...
function(rocm_wrap_header_file)
    cmake_parse_arguments(PARSE "" "INCLUDE_FILE;GUARD;LOCATION;INSTALL_LOCATION" "" ${argv})
    if(NOT PARSE_INSTALL_LOCATION)
        set(PARSE_INSTALL_LOCATION "include/${CMAKE_PROJECT_NAME}")
    endif()
